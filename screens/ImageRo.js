...
export default class ImageRo extends React.Component {
  ...
  _onRotateHandlerStateChange = event => {
    if (event.nativeEvent.oldState === State.ACTIVE) {
      console.log("e.rotation", event.nativeEvent.rotation)
          ...
          <RotationGestureHandler
            ...
            <Animated.View style={styles.wrapper}>
              <PinchGestureHandler
                ...
                <ImageBackground source={require('./kaler.png')} style={styles.bgImage}>
                <Animated.Image
                    style={[
